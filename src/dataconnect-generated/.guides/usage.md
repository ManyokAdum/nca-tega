...
```ts
import { useCreateUser, useGetUserById, useUpdateUserProfile, useListAllUsers } from '@dataconnect/generated/react';
...
```js
import { createUser, getUserById, updateUserProfile, listAllUsers } from '@dataconnect/generated';
