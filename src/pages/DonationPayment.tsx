...
const DonationPayment = () => {
    ...
    const { amount, currency, donorName, donorEmail, donorPhone } = donationData;
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setTimeout(() => {
            toast({
                ...
                description: `Your donation of ${amount} ${currency} has been processed. Thank you for your support!`,
            });
                    ...
                    <div className="container">
                        <div className="mx-auto max-w-3xl text-center">
                            ...
                            <p className="text-lg text-primary-foreground/90 md:text-xl">
                                Secure payment processing for your contribution
                            </p>
                        </div>
                    </div>
                </section>
                                                ...
                                                <Button type="submit" size="lg" className="w-full" disabled={isProcessing}>
                                                    {isProcessing ? (
                                                        ...
                                                        <>
                                                            ...
                                                            Complete Donation of {amount} {currency}
                                                        </>
                                                    )}
                                                </Button>
                                            ...
                                            <div className="space-y-3 text-sm">
                                                ...
                                                {donorEmail && (
                                                    <div className="flex justify-between">
                                                        ...
                                                        <span className="font-medium text-xs">{donorEmail}</span>
                                                    </div>
                                                )}
                                                <Separator />
